...
//    Serial.println(time(nullptr));
    delay(1500); }
  t.every(5000, Proc_Humidity,(void*)&DHT01);
}
...
void Proc_Humidity(void* context)
{
  ...
  unsigned char cmd[8] = {0x01,0x03,0x00,0x00,0x00,0x02,0xc4,0x0b};
  ...
  float  res_temp= (float)(data[3]*256+data[4])/10.0;
  float  res_humi= (float)(data[5]*256+data[6])/10.0;
...
//    Serial.println(dt);
    ...
    String humi = String(res_humi);
    String temp = String(res_temp);
